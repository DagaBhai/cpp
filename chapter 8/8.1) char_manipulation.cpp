...
int main(){
    ...
    cout<<"islnum"<<endl;
    cout<<boolalpha;
    //static_cast<bool> Older C++ libraries or compilers might return 
    //different non-zero integer values from isalnum()
    cout<<"c is alphanumeric : "<<static_cast<bool>(isalnum('c'))<<endl;
    cout<<"^ is alphanumeric : "<<static_cast<bool>(isalnum('^'))<<endl;
